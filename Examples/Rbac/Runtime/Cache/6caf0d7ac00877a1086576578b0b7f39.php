<?php if (!defined('THINK_PATH')) exit();?><style> body{font-family:tahoma}
...
</style><!-- 版权信息区域 --><div id="footer" class="footer" >Powered by ThinkPHP <?php echo (THINK_VERSION); ?> | Template designed by <a target="_blank" href="http://www.topthink.com.cn">TopThink</a><span id="run"></span></div></body></html>