...
*/
	...
	<table cellspacing="0" cellpadding="0" id="maintable" class="formtable">
		...
		<td><a href="<?php echo U('Job/resume',array('id'=>$vo['id']));?>"><img src="__PUBLIC__/Admin/images/search.gif" alt="查看应聘人员" align="absmiddle" /></a>　<a href="<?php echo U('Job/modify',array('id'=>$vo['id']));?>"><img src="__PUBLIC__/Admin/images/modify22px.gif" alt="编辑" align="absmiddle" /></a></td>
