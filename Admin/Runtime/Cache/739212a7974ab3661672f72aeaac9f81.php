...
*/
    ...
    <div class="top_action"><a href="<?php echo U("Page/insert");?>">录入单页</a> | <a href="<?php echo U("Company/picture");?>">公司掠影</a></div>
	<table cellspacing="0" cellpadding="0" id="maintable" class="formtable">
		...
		<td> <a href="<?php echo U('Page/modify',array('id'=>$vo['id']));?>"><img src="__PUBLIC__/Admin/images/modify22px.gif" alt="编辑" align="absmiddle" /></a>　</td>
