...
<?php if(isset($dataList)): ?><form method="post" action="<?php echo U('Feedback/doCommand');?>">
	...
	<table cellspacing="0" cellpadding="0" id="maintable" class="formtable">
		<?php if(is_array($dataList)): $i = 0; $__LIST__ = $dataList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="trbg">
		    ...
		    <th style="font-size:14px;"> <?php echo (($vo["title"])?($vo["title"]):"<s>N/A</s>"); ?> <a href="<?php echo U('Feedback/modify',array('id'=>$vo['id']));?>"><img src="__PUBLIC__/Admin/images/modify22px.gif" alt="编辑/回复" border="0" align="absmiddle" /></a></th>
		  ...
		  <tr class="trbg">
		    <th style="text-align:right;"><img src="__PUBLIC__/Admin/images/user.gif" alt="<?php echo (($vo["username"])?($vo["username"]):'主题'); ?>" align="absmiddle" /></th>
