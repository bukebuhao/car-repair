...
*/
	...
	<form method="post" action="<?php echo U('Notice/doCommand');?>">
	<div class="body_content">
    <div class="top_action"><a href="<?php echo U('Notice/insert');?>">录入公告</a></div>
	<table cellspacing="0" cellpadding="0" id="maintable" class="formtable">
		...
		<td><input name="title[]" id="title[]" value="<?php echo ($vo["title"]); ?>" size="40" class="input-style">
		  <span style="text-align:left"><?php echo (statusicon($vo["status"],1,$frontUrl,'hidden.gif','隐藏')); echo (statusicon($vo["istop"],1,$frontUrl,'istop.gif','置顶')); echo (attachstatus($vo["attach"],1,$frontUrl,'attach.png','附件')); ?> </span></td>
		<td><input name="display_order[]" id="display_order[]" value="<?php echo ($vo["display_order"]); ?>" size="5" /></td>
		<td><?php echo (date("Y-m-d",$vo["create_time"])); ?></td>
		<td><a href="<?php echo U('Notice/modify',array('id'=>$vo['id']));?>"><img src="__PUBLIC__/Admin/images/modify22px.gif" alt="编辑" align="absmiddle" /></a></td>
