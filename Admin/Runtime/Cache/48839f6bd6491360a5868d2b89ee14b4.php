...
<div class="top_action"><a href="<?php echo U("Admin/insert");?>">录入管理员</a> | <a href="<?php echo U("AdminRole/index");?>">角色管理</a></div>
	<table cellspacing="0" cellpadding="0" id="maintable" class="formtable">
		...
		<td>   
<a href="<?php echo U("Admin/modify",array('id'=>$vo['id']));?>"><img src="__PUBLIC__/Admin/images/modify22px.gif" alt="编辑" align="absmiddle" /></a><?php if(($vo['id']) != "1"): ?><a href="<?php echo U("Admin/doCommand",array('operate'=>'delete','id'=>$vo['id']));?>" class="confirmSubmit"><img src="__PUBLIC__/Admin/images/delete.gif" alt="删除" align="absmiddle" /></a><?php endif; ?>
              </td>
