...
*/
	...
	<form method="post" action="<?php echo U("News/doCommand");?>">
	<div class="body_content">
    <div class="top_action"><a href="<?php echo U("News/insert");?>">录入新闻</a> | <a href="<?php echo U("Category/index");?>">类别管理</a></div>
    <table cellspacing="0" cellpadding="0"  id="maintable" class="formtable">
		...
		<td> <a href="<?php echo U('News/modify',array('id'=>$vo['id']));?>"><img src="__PUBLIC__/Admin/images/modify22px.gif" alt="编辑" align="absmiddle" /></a></td>
