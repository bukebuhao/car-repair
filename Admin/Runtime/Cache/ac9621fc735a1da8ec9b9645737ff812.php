...
<div class="mainarea">
<div class="maininner">
<form method="post" action="<?php echo U("News/doModify");?>" enctype="multipart/form-data" id="mainFrom">
	<div class="body_content">
		<div class="top_action"><a href="__URL__">浏览新闻</a> | <a href="<?php echo U("News/insert");?>">录入新闻</a> | <a href="<?php echo U("Category/index");?>">分类管理</a></div>
		...
		<?php if(($vo['attach']) == "1"): ?>不更换请不要选择新图片　<a href="__UPLOAD__/<?php echo ($vo["attach_image"]); ?>" target="_blank"><img src="__PUBLIC__/Admin/images/image.gif" border="0" align="absmiddle" /></a>　<input name="deleteImage" type="radio" value="1" />转换为普通新闻<?php endif; ?></td></tr>
         <tr>
