 ...
 * @version        	$Id: LinkAction.class.php v1.0 2011-7-28 Administrator tengzhiwangluoruanjian $
...
class LinkAction extends CommonAction
{
    ...
    public function doCommand()
    {
        ...
        switch ($operate){
            ...
            case 'update': parent::_batchModify($_POST, array('title', 'link_url', 'display_order'));break;
